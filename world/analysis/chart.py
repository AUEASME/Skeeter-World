...
# Create a 2D scatter plot charting ciKillRate vs. ciRescueRate vs. max(infectionRatio), with the infectionRatio determining the size of the points.
fig = plt.figure()
...
for experiment in data:
    ...
    y.append(experiment["ciRescueRate"])
